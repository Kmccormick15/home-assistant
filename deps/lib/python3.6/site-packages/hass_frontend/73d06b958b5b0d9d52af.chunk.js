...
`}static get properties(){return{hass:{type:Object},progress:{type:Boolean,value:!1},disabled:{type:Boolean,value:!1}}}tempClass(className){var classList=this.$.container.classList;classList.add(className);setTimeout(()=>{classList.remove(className)},1e3)}ready(){super.ready();this.addEventListener("click",ev=>this.buttonTapped(ev))}buttonTapped(ev){if(this.progress)ev.stopPropagation()}actionSuccess(){this.tempClass("success")}actionError(){this.tempClass("error")}computeDisabled(disabled,progress){return disabled||progress}}customElements.define("ha-progress-button",HaProgressButton)},275:function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(4),_ha_progress_button_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(207),_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(14);class HaCallApiButton extends Object(_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_3__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__.a){static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__.a`
    <ha-progress-button id="progress" progress="[[progress]]" on-click="buttonTapped" disabled="[[disabled]]"><slot></slot></ha-progress-button>
`}static get properties(){return{hass:Object,progress:{type:Boolean,value:!1},path:String,method:{type:String,value:"POST"},data:{type:Object,value:{}},disabled:{type:Boolean,value:!1}}}buttonTapped(){this.progress=!0;const eventData={method:this.method,path:this.path,data:this.data};this.hass.callApi(this.method,this.path,this.data).then(resp=>{this.progress=!1;this.$.progress.actionSuccess();eventData.success=!0;eventData.response=resp},resp=>{this.progress=!1;this.$.progress.actionError();eventData.success=!1;eventData.response=resp}).then(()=>{this.fire("hass-api-called",eventData)})}}customElements.define("ha-call-api-button",HaCallApiButton)},624:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var app_route=__webpack_require__(89),utils_async=__webpack_require__(8),debounce=__webpack_require__(15),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),ha_config_section=__webpack_require__(200),paper_button=__webpack_require__(55),paper_card=__webpack_require__(153),paper_item_body=__webpack_require__(198),paper_toggle_button=__webpack_require__(158),ha_call_api_button=__webpack_require__(275),hass_subpage=__webpack_require__(205),ha_style=__webpack_require__(121),format_date_time=__webpack_require__(77),events_mixin=__webpack_require__(14);class ha_config_cloud_account_HaConfigCloudAccount extends Object(events_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style include="iron-flex ha-style">
      [slot=introduction] {
        margin: -1em 0;
      }
...
//# sourceMappingURL=73d06b958b5b0d9d52af.chunk.js.map