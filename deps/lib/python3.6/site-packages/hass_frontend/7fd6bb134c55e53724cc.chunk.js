(window.webpackJsonp=window.webpackJsonp||[]).push([[41],{157:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__(131);const PaperSliderClass=customElements.get("paper-slider");class HaPaperSlider extends PaperSliderClass{static get template(){const tpl=document.createElement("template");tpl.innerHTML=PaperSliderClass.template.innerHTML;const styleEl=document.createElement("style");styleEl.innerHTML=`
...
`}static get properties(){return{hass:Object,stateObj:Object,risingDate:{type:Object,computed:"computeRising(stateObj)"},settingDate:{type:Object,computed:"computeSetting(stateObj)"}}}computeRising(stateObj){return new Date(stateObj.attributes.next_rising)}computeSetting(stateObj){return new Date(stateObj.attributes.next_setting)}computeOrder(risingDate,settingDate){return risingDate>settingDate?["set","ris"]:["ris","set"]}itemCaption(type){return"ris"===type?"Rising ":"Setting "}itemDate(type){return"ris"===type?this.risingDate:this.settingDate}itemValue(type){return Object(format_time.a)(this.itemDate(type),this.language)}}customElements.define("more-info-sun",more_info_sun_MoreInfoSun);class more_info_updater_MoreInfoUpdater extends polymer_element.a{static get template(){return html_tag.a`
    <style>
      .link {
        color: #03A9F4;
      }
...
//# sourceMappingURL=7fd6bb134c55e53724cc.chunk.js.map