...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget();this.classList.add("no-padding")},attached:function(){this._ensureTarget();requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",0<this.scrollTarget.scrollTop);this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight);this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement;if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}})},635:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _polymer_app_layout_app_header_layout_app_header_layout_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(155),_polymer_app_layout_app_header_app_header_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(154),_polymer_app_layout_app_toolbar_app_toolbar_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(122),_polymer_paper_card_paper_card_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(153),_polymer_paper_dialog_scrollable_paper_dialog_scrollable_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(221),_polymer_paper_dialog_paper_dialog_js__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(211),_polymer_paper_icon_button_paper_icon_button_js__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(62),_polymer_paper_item_paper_item_body_js__WEBPACK_IMPORTED_MODULE_7__=__webpack_require__(198),_polymer_paper_item_paper_item_js__WEBPACK_IMPORTED_MODULE_8__=__webpack_require__(120),_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_9__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_10__=__webpack_require__(4),_components_buttons_ha_call_service_button_js__WEBPACK_IMPORTED_MODULE_11__=__webpack_require__(209),_components_ha_menu_button_js__WEBPACK_IMPORTED_MODULE_12__=__webpack_require__(135),_resources_ha_style_js__WEBPACK_IMPORTED_MODULE_13__=__webpack_require__(121),_common_datetime_format_date_time_js__WEBPACK_IMPORTED_MODULE_14__=__webpack_require__(77),_common_datetime_format_time_js__WEBPACK_IMPORTED_MODULE_15__=__webpack_require__(112),_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_16__=__webpack_require__(14);let registeredDialog=!1;class HaPanelDevInfo extends Object(_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_16__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_10__.a){static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_9__.a`
    ...
    `}static get properties(){return{hass:Object,narrow:{type:Boolean,value:!1},showMenu:{type:Boolean,value:!1},errorLog:{type:String,value:""},updating:{type:Boolean,value:!0},items:{type:Array,value:[]},selectedItem:Object,jsVersion:{type:String,value:"latest"},customUiList:{type:Array,value:window.CUSTOM_UI_LIST||[]},loadedComponents:{type:Array,value:[]}}}ready(){super.ready();this.addEventListener("hass-service-called",ev=>this.serviceCalled(ev));this.$.showlog.addEventListener("iron-overlay-opened",ev=>{if(ev.target.withBackdrop){ev.target.parentNode.insertBefore(ev.target.backdropElement,ev.target)}})}serviceCalled(ev){if(ev.detail.success&&"system_log"===ev.detail.domain){if("clear"===ev.detail.service){this.items=[]}}}connectedCallback(){super.connectedCallback();this.$.scrollable.dialogElement=this.$.showlog;this._fetchData();this.loadedComponents=this.hass.config.components;if(!registeredDialog){registeredDialog=!0;this.fire("register-dialog",{dialogShowEvent:"show-loaded-components",dialogTag:"ha-loaded-components",dialogImport:()=>__webpack_require__.e(56).then(__webpack_require__.bind(null,618))})}if(!window.CUSTOM_UI_LIST){setTimeout(()=>{this.customUiList=window.CUSTOM_UI_LIST||[]},1e3)}else{this.customUiList=window.CUSTOM_UI_LIST}}refreshErrorLog(ev){if(ev)ev.preventDefault();this.errorLog="Loading error log\u2026";this.hass.callApi("GET","error_log").then(log=>{this.errorLog=log||"No errors have been reported."})}fullTimeStamp(date){return new Date(1e3*date)}formatTime(date){const today=new Date().setHours(0,0,0,0),dateTime=new Date(1e3*date),dateTimeDay=new Date(1e3*date).setHours(0,0,0,0);return dateTimeDay<today?Object(_common_datetime_format_date_time_js__WEBPACK_IMPORTED_MODULE_14__.a)(dateTime):Object(_common_datetime_format_time_js__WEBPACK_IMPORTED_MODULE_15__.a)(dateTime)}openLog(event){this.selectedItem=event.model.item;this.$.showlog.open()}_fetchData(){this.updating=!0;this.hass.callApi("get","error/all").then(items=>{this.items=items;this.updating=!1})}_defaultPageText(){return`>> ${"lovelace"===localStorage.defaultPage?"Remove":"Set"} lovelace as default page on this device <<`}_toggleDefaultPage(){if("lovelace"===localStorage.defaultPage){delete localStorage.defaultPage}else{localStorage.defaultPage="lovelace"}this.$.love.innerText=this._defaultPageText()}_showComponents(){this.fire("show-loaded-components",{hass:this.hass})}}customElements.define("ha-panel-dev-info",HaPanelDevInfo)}}]);
//# sourceMappingURL=86af84d97a438e283d29.chunk.js.map