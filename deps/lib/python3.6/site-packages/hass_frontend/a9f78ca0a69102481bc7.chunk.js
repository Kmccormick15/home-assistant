...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[_paper_item_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a]})},254:function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathfloor=Math.floor,_Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathmax=Math.max,_Mathmin=Math.min,spacing=__webpack_require__(217),style=__webpack_require__(222),overlay=__webpack_require__(334);const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
    <style include="lumo-overlay">
      /* stylelint-disable no-empty-source */
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer.content);var vaadin_overlay=__webpack_require__(280),menu_overlay=__webpack_require__(335);const vaadin_combo_box_dropdown_styles_$_documentContainer=document.createElement("template");vaadin_combo_box_dropdown_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_dropdown_styles_$_documentContainer.content);var color=__webpack_require__(228),font_icons=__webpack_require__(281),sizing=__webpack_require__(229),typography=__webpack_require__(233);const vaadin_item_styles_$_documentContainer=document.createElement("template");vaadin_item_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild(vaadin_item_styles_$_documentContainer.content);var polymer_element=__webpack_require__(4),vaadin_themable_mixin=__webpack_require__(218);/**
@license
