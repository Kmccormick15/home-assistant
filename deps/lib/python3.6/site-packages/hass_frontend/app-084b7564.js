...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const p=Element.prototype,normalizedMatchesSelector=p.matches||p.matchesSelector||p.mozMatchesSelector||p.msMatchesSelector||p.oMatchesSelector||p.webkitMatchesSelector,matchesSelector=function(node,selector){return normalizedMatchesSelector.call(node,selector)};class DomApi{constructor(node){this.node=node}observeNodes(callback){return new _utils_flattened_nodes_observer_js__WEBPACK_IMPORTED_MODULE_2__.a(this.node,callback)}unobserveNodes(observerHandle){observerHandle.disconnect()}notifyObserver(){}deepContains(node){if(this.node.contains(node)){return!0}let n=node,doc=node.ownerDocument;while(n&&n!==doc&&n!==this.node){n=n.parentNode||n.host}return n===this.node}getOwnerRoot(){return this.node.getRootNode()}getDistributedNodes(){return"slot"===this.node.localName?this.node.assignedNodes({flatten:!0}):[]}getDestinationInsertionPoints(){let ip$=[],n=this.node.assignedSlot;while(n){ip$.push(n);n=n.assignedSlot}return ip$}importNode(node,deep){let doc=this.node instanceof Document?this.node:this.node.ownerDocument;return doc.importNode(node,deep)}getEffectiveChildNodes(){return _utils_flattened_nodes_observer_js__WEBPACK_IMPORTED_MODULE_2__.a.getFlattenedNodes(this.node)}queryDistributedElements(selector){let c$=this.getEffectiveChildNodes(),list=[];for(let i=0,l=c$.length,c;i<l&&(c=c$[i]);i++){if(c.nodeType===Node.ELEMENT_NODE&&matchesSelector(c,selector)){list.push(c)}}return list}get activeElement(){let node=this.node;return node._activeElement!==void 0?node._activeElement:node.activeElement}}class EventApi{constructor(event){this.event=event}get rootTarget(){return this.event.composedPath()[0]}get localTarget(){return this.event.target}get path(){return this.event.composedPath()}}DomApi.prototype.cloneNode;DomApi.prototype.appendChild;DomApi.prototype.insertBefore;DomApi.prototype.removeChild;DomApi.prototype.replaceChild;DomApi.prototype.setAttribute;DomApi.prototype.removeAttribute;DomApi.prototype.querySelector;DomApi.prototype.querySelectorAll;DomApi.prototype.parentNode;DomApi.prototype.firstChild;DomApi.prototype.lastChild;DomApi.prototype.nextSibling;DomApi.prototype.previousSibling;DomApi.prototype.firstElementChild;DomApi.prototype.lastElementChild;DomApi.prototype.nextElementSibling;DomApi.prototype.previousElementSibling;DomApi.prototype.childNodes;DomApi.prototype.children;DomApi.prototype.classList;DomApi.prototype.textContent;DomApi.prototype.innerHTML;(function(proto,methods){for(let i=0,method;i<methods.length;i++){method=methods[i];proto[method]=function(){return this.node[method].apply(this.node,arguments)}}})(DomApi.prototype,["cloneNode","appendChild","insertBefore","removeChild","replaceChild","setAttribute","removeAttribute","querySelector","querySelectorAll"]);(function(proto,properties){for(let i=0,name;i<properties.length;i++){name=properties[i];Object.defineProperty(proto,name,{get:function(){const domApi=this;return domApi.node[name]},configurable:!0})}})(DomApi.prototype,["parentNode","firstChild","lastChild","nextSibling","previousSibling","firstElementChild","lastElementChild","nextElementSibling","previousElementSibling","childNodes","children","classList"]);(function(proto,properties){for(let i=0,name;i<properties.length;i++){name=properties[i];Object.defineProperty(proto,name,{get:function(){const domApi=this;return domApi.node[name]},set:function(value){this.node[name]=value},configurable:!0})}})(DomApi.prototype,["textContent","innerHTML"]);const dom=function(obj){obj=obj||document;if(!obj.__domApi){let helper;if(obj instanceof Event){helper=new EventApi(obj)}else{helper=new DomApi(obj)}obj.__domApi=helper}return obj.__domApi}},function(module,__webpack_exports__,__webpack_require__){"use strict";var legacy_element_mixin=__webpack_require__(42),polymer_fn=__webpack_require__(3),templatizer_behavior=__webpack_require__(94),boot=__webpack_require__(7),property_effects=__webpack_require__(32),mutable_data=__webpack_require__(23),gesture_event_listeners=__webpack_require__(49);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/const IronFormElementBehavior={properties:{name:{type:String},value:{notify:!0,type:String},required:{type:Boolean,value:!1}},attached:function(){},detached:function(){}}},function(module,__webpack_exports__,__webpack_require__){"use strict";var boot=__webpack_require__(7),settings=__webpack_require__(12),mixin=__webpack_require__(6),style_gather=__webpack_require__(41),resolve_url=__webpack_require__(9),dom_module=__webpack_require__(25),property_effects=__webpack_require__(32),properties_changed=__webpack_require__(51);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
</dom-module>`;document.head.appendChild($_documentContainer.content)},function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathmax4=Math.max;__webpack_require__.d(__webpack_exports__,"a",function(){return AppScrollEffectsBehavior});var _polymer_polymer_polymer_legacy_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(2),_polymer_iron_scroll_target_behavior_iron_scroll_target_behavior_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(148),_helpers_helpers_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(108);/**
@license
Copyright (c) 2016 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
...
`}static get properties(){return{hass:Object,state:{type:Object,observer:"stateChanged"},_timerTimeRemaining:{type:Number,value:0}}}connectedCallback(){super.connectedCallback();this.startInterval(this.state)}disconnectedCallback(){super.disconnectedCallback();this.clearInterval()}ready(){super.ready();this.addEventListener("click",ev=>this.badgeTap(ev))}badgeTap(ev){ev.stopPropagation();this.fire("hass-more-info",{entityId:this.state.entity_id})}computeClassNames(state){const classes=[Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_3__.a)(state),Object(_common_entity_attribute_class_names_js__WEBPACK_IMPORTED_MODULE_8__.a)(state,["unit_of_measurement"])];return classes.join(" ")}computeValue(localize,state){const domain=Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_3__.a)(state);switch(domain){case"binary_sensor":case"device_tracker":case"updater":case"sun":case"alarm_control_panel":case"timer":return null;case"sensor":default:return"unknown"===state.state?"-":localize(`component.${domain}.state.${state.state}`)||state.state;}}computeIcon(state){if("unavailable"===state.state){return null}const domain=Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_3__.a)(state);switch(domain){case"alarm_control_panel":if("pending"===state.state){return"hass:clock-fast"}if("armed_away"===state.state){return"hass:nature"}if("armed_home"===state.state){return"hass:home-variant"}if("armed_night"===state.state){return"hass:weather-night"}if("armed_custom_bypass"===state.state){return"hass:security-home"}if("triggered"===state.state){return"hass:alert-circle"}return Object(_common_entity_domain_icon_js__WEBPACK_IMPORTED_MODULE_5__.a)(domain,state.state);case"binary_sensor":case"device_tracker":case"updater":return Object(_common_entity_state_icon_js__WEBPACK_IMPORTED_MODULE_6__.a)(state);case"sun":return"above_horizon"===state.state?Object(_common_entity_domain_icon_js__WEBPACK_IMPORTED_MODULE_5__.a)(domain):"hass:brightness-3";case"timer":return"active"===state.state?"hass:timer":"hass:timer-off";default:return null;}}computeImage(state){return state.attributes.entity_picture||null}computeLabel(localize,state,_timerTimeRemaining){const domain=Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_3__.a)(state);if("unavailable"===state.state||["device_tracker","alarm_control_panel"].includes(domain)){return localize(`state_badge.${domain}.${state.state}`)||localize(`state_badge.default.${state.state}`)||state.state}if("timer"===domain){return Object(_common_datetime_seconds_to_duration_js__WEBPACK_IMPORTED_MODULE_9__.a)(_timerTimeRemaining)}return state.attributes.unit_of_measurement||null}computeDescription(state){return Object(_common_entity_compute_state_name_js__WEBPACK_IMPORTED_MODULE_4__.a)(state)}stateChanged(stateObj){this.updateStyles();this.startInterval(stateObj)}clearInterval(){if(this._updateRemaining){clearInterval(this._updateRemaining);this._updateRemaining=null}}startInterval(stateObj){this.clearInterval();if("timer"===Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_3__.a)(stateObj)){this.calculateTimerRemaining(stateObj);if("active"===stateObj.state){this._updateRemaining=setInterval(()=>this.calculateTimerRemaining(this.state),1e3)}}}calculateTimerRemaining(stateObj){this._timerTimeRemaining=Object(_common_entity_timer_time_remaining_js__WEBPACK_IMPORTED_MODULE_7__.a)(stateObj)}}customElements.define("ha-state-label-badge",HaStateLabelBadge)},function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_polymer_lib_utils_async_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(8),_polymer_polymer_lib_utils_debounce_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(15),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(4),_common_entity_compute_state_name_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(28),_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(22),_common_entity_compute_state_display_js__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(110),_mixins_localize_mixin_js__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(13);const RECENT_CACHE={},DOMAINS_USE_LAST_UPDATED=["thermostat","climate"],LINE_ATTRIBUTES_TO_KEEP=["temperature","current_temperature","target_temp_low","target_temp_high"],stateHistoryCache={};function computeHistory(hass,stateHistory,localize,language){const lineChartDevices={},timelineDevices=[];if(!stateHistory){return{line:[],timeline:[]}}stateHistory.forEach(stateInfo=>{if(0===stateInfo.length){return}const stateWithUnit=stateInfo.find(state=>"unit_of_measurement"in state.attributes);let unit=!1;if(stateWithUnit){unit=stateWithUnit.attributes.unit_of_measurement}else if("climate"===Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_4__.a)(stateInfo[0])){unit=hass.config.unit_system.temperature}if(!unit){timelineDevices.push({name:Object(_common_entity_compute_state_name_js__WEBPACK_IMPORTED_MODULE_3__.a)(stateInfo[0]),entity_id:stateInfo[0].entity_id,data:stateInfo.map(state=>({state_localize:Object(_common_entity_compute_state_display_js__WEBPACK_IMPORTED_MODULE_5__.a)(localize,state,language),state:state.state,last_changed:state.last_changed})).filter((element,index,arr)=>{if(0===index)return!0;return element.state!==arr[index-1].state})})}else if(unit in lineChartDevices){lineChartDevices[unit].push(stateInfo)}else{lineChartDevices[unit]=[stateInfo]}});const unitStates=Object.keys(lineChartDevices).map(unit=>({unit:unit,identifier:lineChartDevices[unit].map(states=>states[0].entity_id).join(""),data:lineChartDevices[unit].map(states=>{const last=states[states.length-1],domain=Object(_common_entity_compute_state_domain_js__WEBPACK_IMPORTED_MODULE_4__.a)(last);return{domain:domain,name:Object(_common_entity_compute_state_name_js__WEBPACK_IMPORTED_MODULE_3__.a)(last),entity_id:last.entity_id,states:states.map(state=>{const result={state:state.state,last_changed:state.last_changed};if(DOMAINS_USE_LAST_UPDATED.includes(domain)){result.last_changed=state.last_updated}LINE_ATTRIBUTES_TO_KEEP.forEach(attr=>{if(attr in state.attributes){result.attributes=result.attributes||{};result.attributes[attr]=state.attributes[attr]}});return result}).filter((element,index,arr)=>{if(0===index||index===arr.length-1)return!0;function compare(obj1,obj2){if(obj1.state!==obj2.state)return!1;if(!obj1.attributes&&!obj2.attributes)return!0;if(!obj1.attributes||!obj2.attributes)return!1;return LINE_ATTRIBUTES_TO_KEEP.every(attr=>obj1.attributes[attr]===obj2.attributes[attr])}return!compare(element,arr[index-1])||!compare(element,arr[index+1])})}})}));return{line:unitStates,timeline:timelineDevices}}class HaStateHistoryData extends Object(_mixins_localize_mixin_js__WEBPACK_IMPORTED_MODULE_6__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_2__.a){static get properties(){return{hass:{type:Object,observer:"hassChanged"},filterType:String,cacheConfig:Object,startTime:Date,endTime:Date,entityId:String,isLoading:{type:Boolean,value:!0,readOnly:!0,notify:!0},data:{type:Object,value:null,readOnly:!0,notify:!0}}}static get observers(){return["filterChangedDebouncer(filterType, entityId, startTime, endTime, cacheConfig, localize, language)"]}connectedCallback(){super.connectedCallback();this.filterChangedDebouncer(this.filterType,this.entityId,this.startTime,this.endTime,this.cacheConfig,this.localize,this.language)}disconnectedCallback(){if(this._refreshTimeoutId){window.clearInterval(this._refreshTimeoutId);this._refreshTimeoutId=null}super.disconnectedCallback()}hassChanged(newHass,oldHass){if(!oldHass&&!this._madeFirstCall){this.filterChangedDebouncer(this.filterType,this.entityId,this.startTime,this.endTime,this.cacheConfig,this.localize,this.language)}}filterChangedDebouncer(...args){this._debounceFilterChanged=_polymer_polymer_lib_utils_debounce_js__WEBPACK_IMPORTED_MODULE_1__.a.debounce(this._debounceFilterChanged,_polymer_polymer_lib_utils_async_js__WEBPACK_IMPORTED_MODULE_0__.d.after(0),()=>{this.filterChanged(...args)})}filterChanged(filterType,entityId,startTime,endTime,cacheConfig,localize,language){if(!this.hass)return;if(cacheConfig&&!cacheConfig.cacheKey)return;if(!localize||!language)return;this._madeFirstCall=!0;let data;if("date"===filterType){if(!startTime||!endTime)return;data=this.getDate(startTime,endTime,localize,language)}else if("recent-entity"===filterType){if(!entityId)return;if(cacheConfig){data=this.getRecentWithCacheRefresh(entityId,cacheConfig,localize,language)}else{data=this.getRecent(entityId,startTime,endTime,localize,language)}}else{return}this._setIsLoading(!0);data.then(stateHistory=>{this._setData(stateHistory);this._setIsLoading(!1)})}getEmptyCache(language){return{prom:Promise.resolve({line:[],timeline:[]}),language:language,data:{line:[],timeline:[]}}}getRecentWithCacheRefresh(entityId,cacheConfig,localize,language){if(this._refreshTimeoutId){window.clearInterval(this._refreshTimeoutId);this._refreshTimeoutId=null}if(cacheConfig.refresh){this._refreshTimeoutId=window.setInterval(()=>{this.getRecentWithCache(entityId,cacheConfig,localize,language).then(stateHistory=>{this._setData(Object.assign({},stateHistory))})},1e3*cacheConfig.refresh)}return this.getRecentWithCache(entityId,cacheConfig,localize,language)}mergeLine(historyLines,cacheLines){historyLines.forEach(line=>{const unit=line.unit,oldLine=cacheLines.find(cacheLine=>cacheLine.unit===unit);if(oldLine){line.data.forEach(entity=>{const oldEntity=oldLine.data.find(cacheEntity=>entity.entity_id===cacheEntity.entity_id);if(oldEntity){oldEntity.states=oldEntity.states.concat(entity.states)}else{oldLine.data.push(entity)}})}else{cacheLines.push(line)}})}mergeTimeline(historyTimelines,cacheTimelines){historyTimelines.forEach(timeline=>{const oldTimeline=cacheTimelines.find(cacheTimeline=>cacheTimeline.entity_id===timeline.entity_id);if(oldTimeline){oldTimeline.data=oldTimeline.data.concat(timeline.data)}else{cacheTimelines.push(timeline)}})}pruneArray(originalStartTime,arr){if(0===arr.length)return arr;const changedAfterStartTime=arr.findIndex(state=>{const lastChanged=new Date(state.last_changed);return lastChanged>originalStartTime});if(0===changedAfterStartTime){return arr}const updateIndex=-1===changedAfterStartTime?arr.length-1:changedAfterStartTime-1;arr[updateIndex].last_changed=originalStartTime;return arr.slice(updateIndex)}pruneStartTime(originalStartTime,cacheData){cacheData.line.forEach(line=>{line.data.forEach(entity=>{entity.states=this.pruneArray(originalStartTime,entity.states)})});cacheData.timeline.forEach(timeline=>{timeline.data=this.pruneArray(originalStartTime,timeline.data)})}getRecentWithCache(entityId,cacheConfig,localize,language){const cacheKey=cacheConfig.cacheKey,endTime=new Date,originalStartTime=new Date(endTime);originalStartTime.setHours(originalStartTime.getHours()-cacheConfig.hoursToShow);let startTime=originalStartTime,appendingToCache=!1,cache=stateHistoryCache[cacheKey];if(cache&&startTime>=cache.startTime&&startTime<=cache.endTime&&cache.language===language){startTime=cache.endTime;appendingToCache=!0;if(endTime<=cache.endTime){return cache.prom}}else{cache=stateHistoryCache[cacheKey]=this.getEmptyCache(language)}const prom=Promise.all([cache.prom,this.fetchRecent(entityId,startTime,endTime,appendingToCache)]).then(oldAndNew=>oldAndNew[1]).then(stateHistory=>computeHistory(this.hass,stateHistory,localize,language)).then(stateHistory=>{this.mergeLine(stateHistory.line,cache.data.line);this.mergeTimeline(stateHistory.timeline,cache.data.timeline);if(appendingToCache){this.pruneStartTime(originalStartTime,cache.data)}return cache.data}).catch(err=>{console.error(err);stateHistoryCache[cacheKey]=void 0});cache.prom=prom;cache.startTime=originalStartTime;cache.endTime=endTime;return prom}getRecent(entityId,startTime,endTime,localize,language){const cacheKey=entityId,cache=RECENT_CACHE[cacheKey];if(cache&&Date.now()-cache.created<6e4&&cache.language===language){return cache.data}const prom=this.fetchRecent(entityId,startTime,endTime).then(stateHistory=>computeHistory(this.hass,stateHistory,localize,language),()=>{RECENT_CACHE[entityId]=!1;return null});RECENT_CACHE[cacheKey]={created:Date.now(),language:language,data:prom};return prom}fetchRecent(entityId,startTime,endTime,skipInitialState=!1){let url="history/period";if(startTime){url+="/"+startTime.toISOString()}url+="?filter_entity_id="+entityId;if(endTime){url+="&end_time="+endTime.toISOString()}if(skipInitialState){url+="&skip_initial_state"}return this.hass.callApi("GET",url)}getDate(startTime,endTime,localize,language){const filter=startTime.toISOString()+"?end_time="+endTime.toISOString(),prom=this.hass.callApi("GET","history/period/"+filter).then(stateHistory=>computeHistory(this.hass,stateHistory,localize,language),()=>null);return prom}}customElements.define("ha-state-history-data",HaStateHistoryData)},function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathmax6=Math.max,paper_spinner=__webpack_require__(125),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),debounce=__webpack_require__(15),iron_resizable_behavior=__webpack_require__(45),paper_icon_button=__webpack_require__(62),utils_async=__webpack_require__(8),legacy_class=__webpack_require__(38),format_time=__webpack_require__(112);let scriptsLoaded=null;class ha_chart_base_HaChartBase extends Object(legacy_class.b)([iron_resizable_behavior.a],polymer_element.a){static get template(){return html_tag.a`
  <style>
    :host {
      display: block;
    }
...
`}static get stateInfoTemplate(){return html_tag.a`
    <state-info
      ...
      in-dialog="[[inDialog]]"
    ></state-info>
`}static get properties(){return{hass:Object,stateObj:Object,inDialog:{type:Boolean,value:!1}}}}customElements.define("state-card-climate",state_card_climate_StateCardClimate);var paper_button=__webpack_require__(55),localize_mixin=__webpack_require__(13);class state_card_configurator_StateCardConfigurator extends Object(localize_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style include="iron-flex iron-flex-alignment"></style>
    <style>
      paper-button {
        color: var(--primary-color);
...
`}static get stateInfoTemplate(){return html_tag.a`
    <state-info
      ...
      in-dialog="[[inDialog]]"
    ></state-info>
`}static get properties(){return{hass:Object,stateObj:Object,inDialog:{type:Boolean,value:!1}}}}customElements.define("state-card-vacuum",state_card_vacuum_StateCardVacuum);class state_card_weblink_StateCardWeblink extends polymer_element.a{static get template(){return html_tag.a`
    <style>
      :host {
        display: block;
      }
...
</iron-iconset-svg>`;document.head.appendChild(template.content);var paper_tab=__webpack_require__(140),iron_menu_behavior=__webpack_require__(66),iron_menubar_behavior=__webpack_require__(149),iron_resizable_behavior=__webpack_require__(45),polymer_fn=__webpack_require__(3),polymer_dom=__webpack_require__(1);/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
//# sourceMappingURL=app-084b7564.js.map