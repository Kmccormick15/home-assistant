...
`;template.setAttribute("strip-whitespace","");Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_7__.a)({_template:template,is:"paper-fab",behaviors:[_polymer_paper_behaviors_paper_button_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(icon,src){return 0<icon.length||0<src.length}})},627:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var app_route=__webpack_require__(89),utils_async=__webpack_require__(8),debounce=__webpack_require__(15),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),navigate_mixin=__webpack_require__(81),paper_fab=__webpack_require__(238),paper_item=__webpack_require__(120),paper_card=__webpack_require__(153),paper_item_body=__webpack_require__(197),hass_subpage=__webpack_require__(207),localize_mixin=__webpack_require__(9),events_mixin=__webpack_require__(14);let registeredDialog=!1;class ha_user_picker_HaUserPicker extends Object(events_mixin.a)(Object(navigate_mixin.a)(Object(localize_mixin.a)(polymer_element.a))){static get template(){return html_tag.a`
  <style>
    paper-fab {
      position: fixed;
      bottom: 16px;
...
`}static get properties(){return{hass:Object,users:Array}}connectedCallback(){super.connectedCallback();if(!registeredDialog){registeredDialog=!0;this.fire("register-dialog",{dialogShowEvent:"show-add-user",dialogTag:"ha-dialog-add-user",dialogImport:()=>__webpack_require__.e(62).then(__webpack_require__.bind(null,653))})}}_withDefault(value,defaultValue){return value||defaultValue}_computeUrl(user){return`/config/users/${user.id}`}_addUser(){this.fire("show-add-user",{hass:this.hass,dialogClosedCallback:async({userId})=>{this.fire("reload-users");if(userId)this.navigate(`/config/users/${userId}`)}})}}customElements.define("ha-user-picker",ha_user_picker_HaUserPicker);__webpack_require__(55);class ha_user_editor_HaUserEditor extends Object(events_mixin.a)(Object(navigate_mixin.a)(Object(localize_mixin.a)(polymer_element.a))){static get template(){return html_tag.a`
  <style>
    paper-card {
      display: block;
      max-width: 600px;
